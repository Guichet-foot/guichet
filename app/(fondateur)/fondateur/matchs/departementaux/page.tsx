...
export const metadata = { title: "Matchs Départementals — Fondateur" };

/* eslint-disable @typescript-eslint/no-explicit-any */

export default async function FondateurMatchsDepartementauxPage() {
  ...
  return (
    <div className="space-y-6">
      <FondateurMatchTabBar active="departementaux" />
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <Link href="/fondateur/matchs/departementaux/nouveau">
